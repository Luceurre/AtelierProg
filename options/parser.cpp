...
void parser::parser_write(const std::string& nom,const std::unordered_map<std::string, std::string>& dico) {
...
std::unordered_map<std::string, std::string> parser::parser_read(const std::string& nom) {

    std::string line;       //Variable to stock the line from the txt
    std::unordered_map<std::string, std::string> dico;  //Creation of dico
